...
var path=new _art.Path().moveTo(x,y-radius).arc(0,radius*2,radius).arc(0,radius*-2,radius).close();
return(
_react2.default.createElement(_art.Shape,{d:path,stroke:this.props.stroke,fill:this.props.fill,strokeWidth:1,__source:{fileName:_jsxFileName,lineNumber:26}}));
