...
var horizontalStep=containerWidth/(0,_util.uniqueValuesInDataSets)(data,0).length;
...
currentData.forEach(function(_ref,i){var _ref2=_slicedToArray(_ref,2),_=_ref2[0],dataPoint=_ref2[1];
...
pathArray.push(new _art.Path().moveTo(x,y));
fillPathArray.push(new _art.Path().moveTo(x,containerHeight).lineTo(x,height));
pathSubIndex++;
beginNewPath=false;
}else{
...
_react2.default.createElement(_art.Surface,{width:containerWidth,height:containerHeight,__source:{fileName:_jsxFileName,lineNumber:154}},
multipleLines,
multipleFills)),


_react2.default.createElement(_reactNative.View,{style:{position:'absolute'},__source:{fileName:_jsxFileName,lineNumber:159}},
_react2.default.createElement(_art.Surface,{width:containerWidth,height:containerHeight,__source:{fileName:_jsxFileName,lineNumber:160}})),
...
return(
_react2.default.createElement(_art.Surface,{width:containerWidth,height:containerHeight,__source:{fileName:_jsxFileName,lineNumber:175}},
multipleDataPoints));
